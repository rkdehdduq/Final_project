...
from fundad_test import chat_with_gpt
...
def receive_username():
    ...
    #fundad.py의 user_profile에 사용자 이름을 저장
    user_profile["username"] = username  # user_profile에 username 추가
    user_profile["grade"]= risk_score
